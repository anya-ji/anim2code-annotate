...
export default async function BrowsePage() {
  ...
  for (const trial of trials) {
    ...
    let completedCount = 0, explicitPass = 0, explicitFail = 0, implicitPass = 0, implicitFail = 0
    ...
    trialSummaries.push({ trialId: trial.id, participantCount: pids.length, completedCount, explicitPass, explicitFail, implicitPass, implicitFail })
  }
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                {["Trial ID", "Participants", "Completed", "Explicit Pass", "Explicit Fail", "Implicit Pass", "Implicit Fail"].map((h) => (
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              {participantRows.length === 0 && (
                <tr>
                  <td colSpan={7} className="px-4 py-8 text-center text-gray-400 text-sm">No participants yet.</td>
                </tr>
              )}
            </tbody>
          </table>
